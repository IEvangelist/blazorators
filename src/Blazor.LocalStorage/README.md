# Blazorators: The Source Generated `localStorage` JavaScript Interop library for Blazor Server

The [`Blazor.LocalStorage`](https://www.nuget.org/packages/Blazor.LocalStorage) package consumes the [`Blazor.SourceGenerators`](https://www.nuget.org/packages/Blazor.SourceGenerators) package. It exposes a source generated `ILocalStorage` interface specific to Blazor WebAssembly and the [`localStorage`](https://developer.mozilla.org/docs/Web/API/Window/localStorage) Web API.
