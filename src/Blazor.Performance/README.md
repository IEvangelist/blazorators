...
Generated Performance Timeline, User Timing, Performance Observer, Navigation Timing, and Resource Timing bindings for Blazor Server and hosting-neutral async JavaScript interop.
