...
public class ColonToken : Token
{
    public ColonToken()
    {
        Kind = TypeScriptSyntaxKind.ColonToken;
    }
}
...
public class EqualsToken : Token
{
    public EqualsToken()
    {
        Kind = TypeScriptSyntaxKind.EqualsToken;
    }
}
...
public class EqualsGreaterThanToken : Token
{
    ...
    {
        Kind = TypeScriptSyntaxKind.EqualsGreaterThanToken;
    }
}
...
public class AtToken : Token
{
    public AtToken()
    {
        Kind = TypeScriptSyntaxKind.AtToken;
    }
}
...
public class AwaitKeywordToken : Token
{
    ...
    {
        Kind = TypeScriptSyntaxKind.AwaitKeyword;
    }
}
...
//{
//    //public BinaryOperatorToken() { kind = TypeScriptSyntaxKind.BinaryOperator; }
//}
...
public class ShorthandPropertyAssignment : ObjectLiteralElement, IObjectLiteralElementLike
{
    ...
    public QuestionToken QuestionToken { get; set; }
    public Token EqualsToken { get; set; } // GetCurrentToken<TypeScriptSyntaxKind.EqualsToken>
    ...
    IAccessorDeclaration
{
    ...
    {
        Kind = TypeScriptSyntaxKind.GetAccessor;
    }
...
public class ThisTypeNode : TypeNode
{
    public ThisTypeNode()
    {
        Kind = TypeScriptSyntaxKind.ThisType;
    }
}
...
public class OmittedExpression : Expression, IArrayBindingElement
{
    ...
    {
        Kind = TypeScriptSyntaxKind.OmittedExpression;
    }
}
...
public class PrefixUnaryExpression : IncrementExpression
{
    ...
    public /*PrefixUnaryOperator*/TypeScriptSyntaxKind Operator { get; set; }
...
public class PostfixUnaryExpression : IncrementExpression
{
    ...
    public /*PostfixUnaryOperator*/TypeScriptSyntaxKind Operator { get; set; }
}
...
public class NullLiteral : Node, IPrimaryExpression, ITypeNode
{
    public NullLiteral()
    {
        Kind = TypeScriptSyntaxKind.NullKeyword;
    }
...
public class BooleanLiteral : Node, IPrimaryExpression, ITypeNode
{
    ...
    {
        Kind = TypeScriptSyntaxKind.BooleanKeyword;
    }
...
public class NumericLiteral : LiteralExpression, IPropertyName
{
    ...
    {
        Kind = TypeScriptSyntaxKind.NumericLiteral;
    }
}
...
public class TemplateHead : LiteralLikeNode
{
    public TemplateHead()
    {
        Kind = TypeScriptSyntaxKind.TemplateHead;
    }
}
...
public class TemplateTail : LiteralLikeNode
{
    public TemplateTail()
    {
        Kind = TypeScriptSyntaxKind.TemplateTail;
    }
}
...
public class ObjectLiteralExpression : ObjectLiteralExpressionBase<IObjectLiteralElementLike>
{
    ...
    {
        Kind = TypeScriptSyntaxKind.ObjectLiteralExpression;
    }
...
public class JsxOpeningElement : JsxSelfClosingElement
{
    ...
    {
        Kind = TypeScriptSyntaxKind.JsxOpeningElement;
    }
}
...
public class JsxExpression : Expression, IJsxChild
{
    ...
    public Token DotDotDotToken { get; set; } // GetCurrentToken<TypeScriptSyntaxKind.DotDotDotToken>
    public IExpression Expression { get; set; }
}
...
public class HeritageClause : Node
{
    ...
    public TypeScriptSyntaxKind Token { get; set; } //  TypeScriptSyntaxKind.ExtendsKeyword | TypeScriptSyntaxKind.ImplementsKeyword
...
public class ModuleBlock : Block
{
    public ModuleBlock()
    {
        Kind = TypeScriptSyntaxKind.ModuleBlock;
    }
}
...
public class NamespaceExportDeclaration : DeclarationStatement
{
    ...
    {
        Kind = TypeScriptSyntaxKind.NamespaceExportDeclaration;
    }
}
...
public class JsDocAllType : JsDocType
{
    public JsDocAllType()
    {
        Kind = TypeScriptSyntaxKind.JsDocAllType;
    }
}
...
public class JsDocThisType : JsDocType
{
    ...
    {
        Kind = TypeScriptSyntaxKind.JsDocThisType;
    }
...
public class JsDocLiteralType : JsDocType
{
    ...
    {
        Kind = TypeScriptSyntaxKind.JsDocLiteralType;
    }
...
public class JsDocRecordMember : PropertySignature
{
    ...
    {
        Kind = TypeScriptSyntaxKind.JsDocRecordMember;
    }
}
...
public class SourceFile : Declaration, ISourceFileLike
{
    ...
    public NodeArray<IStatement> Statements { get; set; }
    public Token EndOfFileToken { get; set; } // GetCurrentToken<TypeScriptSyntaxKind.EndOfFileToken>
    public string FileName { get; set; }
...
public class SyntaxList : Node
{
    public SyntaxList()
    {
        Kind = TypeScriptSyntaxKind.SyntaxList;
    }
}
