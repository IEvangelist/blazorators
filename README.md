...
```csharp
[JavaScriptInterop(TypeName = "Geolocation", Url = "https://developer.mozilla.org/en-US/docs/Web/API/Geolocation_API")]
public static partial class GeoLocationExtensions { }
```
...
```javascript
const getCurrentLocation = (dotnetObj, successMethodName, errorMethodName) => {
