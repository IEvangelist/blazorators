...
| [`Blazor.SpeechRecognition.WebAssembly`](https://www.nuget.org/packages/Blazor.SpeechRecognition.WebAssembly) | [![NuGet](https://img.shields.io/nuget/v/Blazor.SpeechRecognition.WebAssembly.svg?style=flat)](https://www.nuget.org/packages/Blazor.SpeechRecognition.WebAssembly) | Razor class library exposing DI-ready `ISpeechRecognitionService` type for the `webkitSpeechRecognition` implementation (relies on `IJSInProcessRuntime`). |
| [`Blazor.Permissions.WebAssembly`](https://www.nuget.org/packages/Blazor.Permissions.WebAssembly) | [![NuGet](https://img.shields.io/nuget/v/Blazor.Permissions.WebAssembly.svg?style=flat)](https://www.nuget.org/packages/Blazor.Permissions.WebAssembly) | Razor class library exposing DI-ready `IPermissionsService` type for the `permissions` implementation (relies on `IJSInProcessRuntime`). |
...
| [`Blazor.SpeechRecognition`](https://www.nuget.org/packages/Blazor.SpeechRecognition) | [![NuGet](https://img.shields.io/nuget/v/Blazor.SpeechRecognition.svg?style=flat)](https://www.nuget.org/packages/Blazor.SpeechRecognition) | Razor class library exposing DI-ready `ISpeechRecognitionService` type for the `webkitSpeechRecognition` implementation (relies on `IJSRuntime`). |
